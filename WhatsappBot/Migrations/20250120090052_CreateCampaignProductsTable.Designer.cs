...
namespace WhatsappBot.Migrations
{
    ...
    [Migration("20250120090052_CreateCampaignProductsTable")]
    partial class CreateCampaignProductsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhatsappBot.Models.CampaignProducts", b =>
                {
                    b.Property<Guid>("CampaignId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WhatsappBot.Models.CampaignProducts", b =>
                {
                    b.HasOne("WhatsappBot.Models.Campaign", "Campaign")
                        .WithMany("CampaignProductsCollectionCollection")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhatsappBot.Models.Product", "Product")
                        .WithMany("CampaignProductsCollectionCollection")
            ...
            modelBuilder.Entity("WhatsappBot.Models.Campaign", b =>
                {
                    ...
                    b.Navigation("CampaignProductsCollectionCollection");
                });
